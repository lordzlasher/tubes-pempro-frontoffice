...
// Title      		 :	Front Office
//
// Short Description : Aplikasi ini merupakan aplikasi yang digunakan untuk 
//					   melakukan boking pada kamar hotel yang biasanya terdapat
//					   pada bagian front office sebuah hotel.
//
// Created by 		 : Surya Dharma , Yoga Pramana and pasek okta
//
//===================================================================================
//===============================================================================
...
//==========Dibuat Oleh Putu Pasek Okta Mahawardana 1404505040=============
//=======================================================================
//====================================================================
...
int CVICALLBACK cari (int panel, int control, int event,
					  void *callbackData, int eventData1, int eventData2)
{
	char namapemesan[100],class[50],NoKmr[50],Fasilitas[100],Tarif[100],LamaInap[30];
	int total;
	switch (event)
	{
		case EVENT_COMMIT:
			...
			GetCtrlVal (panelHandle_4, PANEL_4_COMBO, class);
			SetCtrlVal (panelHandle_5, PANEL_5_STRING_6, class);
			...
			GetCtrlVal (panelHandle_4, PANEL_4_STRING_6, Tarif);
			SetCtrlVal (panelHandle_5, PANEL_5_STRING_4, Tarif);
...
//=========================PANEL PEMBAYARAN===========================
//======================================================================
//==========Fungsi Membuat Tombol Kembali Pada Panel PEMBAYARAN===========
//==========Dibuat Oleh Putu Pasek Okta Mahawardana 1404505040=============
//=======================================================================
//====================================================================
