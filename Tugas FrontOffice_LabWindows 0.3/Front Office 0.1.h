...
#define  PANEL_2_COMMANDBUTTON_3          3       /* control type: command, callback function: (none) */
#define  PANEL_2_COMMANDBUTTON_2          4       /* control type: command, callback function: (none) */
#define  PANEL_2_COMMANDBUTTON            5       /* control type: command, callback function: (none) */
