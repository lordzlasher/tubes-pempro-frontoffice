...
#define  PANEL_5_NUMERIC_2                21      /* control type: numeric, callback function: (none) */
#define  PANEL_5_DECORATION_4             22      /* control type: deco, callback function: (none) */
#define  PANEL_5_COMMANDBUTTON_2          23      /* control type: command, callback function: cari */
#define  PANEL_5_COMMANDBUTTON_3          24      /* control type: command, callback function: kembali */
#define  PANEL_5_COMMANDBUTTON            25      /* control type: command, callback function: print */
#define  PANEL_5_TEXTMSG_13               26      /* control type: textMsg, callback function: (none) */
#define  PANEL_5_TEXTMSG_10               27      /* control type: textMsg, callback function: (none) */
#define  PANEL_5_TEXTMSG_9                28      /* control type: textMsg, callback function: (none) */
#define  PANEL_5_TEXTMSG_12               29      /* control type: textMsg, callback function: (none) */
#define  PANEL_5_TEXTMSG_11               30      /* control type: textMsg, callback function: (none) */
