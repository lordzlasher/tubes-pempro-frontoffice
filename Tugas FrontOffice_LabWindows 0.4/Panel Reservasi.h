...
#define  PANEL_4_TEXTBOX_5                3       /* control type: textBox, callback function: (none) */
#define  PANEL_4_TABLE                    4       /* control type: table, callback function: PANEL_TABLE */
#define  PANEL_4_STRING_2                 5       /* control type: string, callback function: (none) */
#define  PANEL_4_STRING                   6       /* control type: string, callback function: (none) */
#define  PANEL_4_KodBO                    7       /* control type: textMsg, callback function: (none) */
#define  PANEL_4_NamaTamu                 8       /* control type: textMsg, callback function: (none) */
...
#define  PANEL_4_TEXTMSG_4                11      /* control type: textMsg, callback function: (none) */
#define  PANEL_4_BtnHitung                12      /* control type: command, callback function: BtnHitung */
#define  PANEL_4_BtnKembali               13      /* control type: command, callback function: (none) */
#define  PANEL_4_BtnClear                 14      /* control type: command, callback function: (none) */
...
#define  PANEL_4_STRING_3                 21      /* control type: string, callback function: (none) */
