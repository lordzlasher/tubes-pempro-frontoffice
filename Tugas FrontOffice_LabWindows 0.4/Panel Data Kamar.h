...
#define  PANEL_3_STRING_2                 4       /* control type: string, callback function: JenisKamar */
#define  PANEL_3_STRING_3                 5       /* control type: string, callback function: Fasilitas */
#define  PANEL_3_STRING_4                 6       /* control type: string, callback function: TarifKamar */
#define  PANEL_3_COMMANDBUTTON_2          7       /* control type: command, callback function: BTNTambah */
#define  PANEL_3_TABLE                    8       /* control type: table, callback function: PANEL_TABLE */
#define  PANEL_3_PICTURE                  9       /* control type: picture, callback function: (none) */
...
int  CVICALLBACK JenisKamar(int panel, int control, int event, void *callbackData, int eventData1, int eventData2);
